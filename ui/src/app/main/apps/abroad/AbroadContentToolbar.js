...
import {
	...
	setSearchNum,
	setSearchSubmit
} from 'app/main/apps/abroad/store/searchsSlice';

function AbroadContentToolbar(props) {
	const dispatch = useDispatch();
	const searchNum = useSelector(({ abroadApp }) => abroadApp.searchs.searchParams.searchNum);
...
export default withReducer('abroadApp', reducer)(AbroadContentToolbar);

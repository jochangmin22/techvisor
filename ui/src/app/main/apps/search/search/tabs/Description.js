	...
	return (
		...
		>
			<Paper className="w-full rounded-8 shadow mb-16">
				{/* <input value={filtered} onChange={handleFliterChange} /> */}
				<div className="flex flex-col items-start p-12">
					...
					{filtered && (
						<div className="flex items-center mt-24">
							...
							<IconButton disableRipple className="w-40 h-40 mr-8 p-0" onClick={resetFiltered}>

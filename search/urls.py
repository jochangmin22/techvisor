...
urlpatterns = [
    ...
    re_path(URL + "search/family$", csrf_exempt(views.search.get_search_family), name='get_search_family'),
    re_path(URL + "search/ipccpc$", csrf_exempt(views.search.get_search_ipc_cpc), name='get_search_ipc_cpc'),
    re_path(URL + "search/rnd$", csrf_exempt(views.search.get_search_rnd), name='get_search_rnd'),
    re_path(URL + "search/legal$", csrf_exempt(views.search.get_search_legal), name='get_search_legal'),

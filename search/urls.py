...
urlpatterns = [
    ...
    re_path(r"^api/search-app/searchs/vec$", views.get_vec, name='get_vec'),
    re_path(r"^api/search-app/searchs/news$", views.get_news, name='get_news'),
    ...
    re_path(r"^api/search-app/searchs/matrix$", views.get_matrix, name='get_matrix'),
    re_path(r"^api/search-app/searchs/matrixdialog$", views.get_matrix_dialog, name='get_matrix_dialog'),

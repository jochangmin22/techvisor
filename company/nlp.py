...
from .companies import parse_companies, parse_companies_num
...
def kr_nlp(request, category=""):
    ...
    nlp_raw = parse_companies(request, mode="nlp") if params['searchNum'] == '' else parse_companies_num(request, mode="nlp")        

...
urlpatterns = [
    re_path(r"^api/auth/verify-email$", csrf_exempt(views.verify_email), name='verify_email'),
    re_path(r"^api/auth/verify-password$", csrf_exempt(views.verify_password), name='verify-password'),
    ...
    re_path(r"^api/auth/access-token$", csrf_exempt(views.do_access_token), name='do_access_token'),

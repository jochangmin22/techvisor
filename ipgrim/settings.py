...
STOPWORDS = ['가능', '감소', '경우', '과제', '구동', '구비', '구성', '내부', '내지', '단계', '마련', '몸체', '발명', '발생', '방법', '배치', '분류', '사용', '사이', '상기', '상부', '상승', '선택', '세부',
             '수단', '신규', '실시', '영역', '에서', '요약', '용도', '유용', '의약', '이상', '이용', '일부', '장치', '제공', '제조', '적용', '종래', '증가', '처리', '특성', '특정', '특징', '포함', '필요', '하나', '하부', '함유', '해결', '허용']

...
urlpatterns = [
    ...
    re_path(r"^api/search-app/searchs/news_sa$", csrf_exempt(get_news_sa)),
    ...
    re_path(r"^api/search-app/search/ipc-cpc$", csrf_exempt(get_search_ipc_cpc)),
    ...
    re_path(r"^api/search-app/search/applicant-trend$", csrf_exempt(get_search_applicant_trend)),
